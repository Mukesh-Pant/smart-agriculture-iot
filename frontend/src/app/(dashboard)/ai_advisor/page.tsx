  ...
  const downloadPDF = async () => {
    ...
    try {
      const body = {
        ...
        crop_confidence: report.crop_confidence,
        crop_top_3: report.crop_top_3,
        fertilizer: report.fertilizer?.fertilizer,
        fertilizer_confidence: report.fertilizer?.confidence,
        npk_status: report.fertilizer?.npk_status,
        soil_class: report.soil?.fertility_class,
        soil_confidence: report.soil?.confidence,
        irrigation: report.irrigation?.action,
        irrigation_urgency: report.irrigation?.urgency,
        water_amount_mm: report.irrigation?.water_amount_mm,
